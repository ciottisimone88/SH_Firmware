...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC3, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=999999999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=3, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=HAND_COMP_TIMER, CY_INSTANCE_SHORT_NAME=HAND_COMP_TIMER, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=HAND_COMP_TIMER, )
...
module top ;
    ...
    Timer_v2_70_10 HAND_COMP_TIMER (
        .reset(Net_3664),
        .interrupt(Net_3684),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_3688),
        .tc(Net_3689),
        .clock(Net_3671));
    defparam HAND_COMP_TIMER.CaptureCount = 2;
    defparam HAND_COMP_TIMER.CaptureCounterEnabled = 0;
    defparam HAND_COMP_TIMER.DeviceFamily = "PSoC3";
    defparam HAND_COMP_TIMER.InterruptOnCapture = 0;
    defparam HAND_COMP_TIMER.InterruptOnTC = 0;
    defparam HAND_COMP_TIMER.Resolution = 32;
    defparam HAND_COMP_TIMER.SiliconRevision = "3";


	cy_clock_v1_0
		#(.id("06eb80b4-64b0-472f-817c-6b83080d72ca"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
