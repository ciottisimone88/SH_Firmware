...
*
*  EMG_1_DM_STRONG     Strong Drive 
*  EMG_1_DM_OD_HI      Open Drain, Drives High 
*  EMG_1_DM_OD_LO      Open Drain, Drives Low 
*  EMG_1_DM_RES_UP     Resistive Pull Up 
*  EMG_1_DM_RES_DWN    Resistive Pull Down 
*  EMG_1_DM_RES_UPDWN  Resistive Pull Up/Down 
*  EMG_1_DM_DIG_HIZ    High Impedance Digital 
*  EMG_1_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
*  
* Note:
*  Macro EMG_1_ReadPS calls this function. 
*  
*******************************************************************************/
