...
#define ALPHA 50 			///< Emg filter constant
#define BETA  8				///< Current filter constant
#define GAMMA 32 			///< Velocity filter constant
#define DELTA 32 			///< Acceleration filter constant
